    ...
    <div :class="{ dark: isDark }" id="app">
      ...
      <div class="navbar">
        <div class="nav-left">
          ...
          <router-link to="/create-threads" class="nav-link" exact-active-class="active-link">Create Post</router-link>
          <router-link to="/posts" class="nav-link" exact-active-class="active-link">Posts</router-link>
        </div>
        <div class="nav-right">
          <router-link to="/profile" class="nav-link" exact-active-class="active-link">User Profile</router-link>
